...
import { X, Bookmark, Users, MapPin, Clock, MessageCircle, UserCheck, Lock, Globe, Mail, Check, AlertTriangle, Pencil, ExternalLink, User, Mail as MailIcon, Copy, Upload } from "lucide-react";
...
export default function StudyGroupDetail({ group: initialGroup, user, members, isBookmarked, onBookmark, onClose, onRefresh, onOpenLocation }) {
